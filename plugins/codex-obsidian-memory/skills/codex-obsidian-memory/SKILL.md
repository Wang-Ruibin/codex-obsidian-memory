...
- Complete state removal: uninstall optional automation first, then run `uninstall`. Never remove the vault.
...
4. Verify that global memory, the exact repository home and exact branch page load.
